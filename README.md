...
```javascript
import sxsy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-sxsy@deno/mod.js';
```
...
[@stdlib/blas/ext/base/saxpby]: https://github.com/stdlib-js/blas-ext-base-saxpby/tree/deno
