...
var sxsy = tryRequire( resolve( __dirname, './../lib/sxsy.native.js' ) );
var opts = {
	'skip': ( sxsy instanceof Error )
};
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( sxsy.length, 5, 'has expected arity' );
	t.end();
});
